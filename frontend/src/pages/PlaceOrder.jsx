  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      let orderData = {
        ...
        address: formData,  // Make sure to include the address
        items: orderItems,
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <input required onChange={onChangeHandler} name='phone' value={formData.phone} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type='number' placeholder='Enter your Mobile number' />
      </div>
      {/* right side */}
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            <div onClick={() => setMethod('cod')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              ...
              <p className='text-gray-600 text-sm font-medium mx-4'>Cash on Delievery</p>
            </div>
          </div>
          <div className='w-full text-center mt-8  flex items-center justify-center'>
